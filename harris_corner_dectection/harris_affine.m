%% harris_ncc_affine_registration
clear;clc;
%% 获取两幅图像
im1 = imread('k1.jpg');
im2 = imread('k2.jpg');
...
[Locs1,cornerness1] = detHarrisCorners(im1,'im1');
[Locs2,cornerness2] = detHarrisCorners(im2,'im2');
...
img1 = rgb2gray(im1); img1 = imresize(img1,0.15);
img2 = rgb2gray(im2); img2 = imresize(img2,0.15);
